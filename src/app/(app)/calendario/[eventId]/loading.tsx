  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className="flex gap-2">
        <div className="h-7 w-28 animate-pulse rounded-full bg-accent" />
        <div className="h-7 w-24 animate-pulse rounded-full bg-accent" />
      </div>
      ...
      {/* Button skeleton */}
      <div className="h-14 w-full animate-pulse rounded-full bg-accent" />
    </div>
  )
}
