  ...
  return (
    <Card className="border-0 shadow-[6px_6px_9px_rgba(0,0,0,0.08)]">
      <CardHeader className="pb-2 text-center">
        <CardTitle className="text-2xl font-bold text-namo-charcoal">Accedi</CardTitle>
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-xs text-namo-cyan transition-colors hover:text-namo-cyan/80 hover:underline"
              >
